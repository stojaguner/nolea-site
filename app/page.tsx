        ...
        <div className="container">
          ...
          <div className="ingredientsGrid" id="science">
            <div className="ingredientCard">
              ...
              <h3>Ectoin</h3>
              <p>
                Chosen as the signature molecule for the brand story — associated
                with skin support under extreme environmental conditions.
              </p>
            </div>
      ...
      <section className="section" id="story">
        <div className="container">
          <div className="sectionHeader">
            ...
            <p>
              Nolea was conceived as a new category of care — one that honors the
              realities of swimmers’ skin without resorting to a loud, utilitarian
              visual language.
            </p>
          </div>
